...
pub use chrome::{
    ...
    hit_activity_surface, hit_activity_toggle, hit_fixed_chrome, paint_active_metadata,
    paint_activity_drawer, paint_fixed_chrome, paint_research_prompt, paint_status,
};
